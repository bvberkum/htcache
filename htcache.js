...
HTCache = function() { }
HTCache.__name__ = ["HTCache"];
HTCache.onKeyUp = function(evt) {
	if(evt.keyCode == 80) {
...
HTCache.updateLayout = function() {
}
HTCache.main = function() {
	js.Lib.document.onkeyup = HTCache.onKeyUp;
	js.Lib.document.onresize = HTCache.onResize;
	js.Lib.window.onload = HTCache.onLoad;
}
HTCache.prototype.__class__ = HTCache;
$_ = {}
js.Boot.__res = {}
js.Boot.__init();
{
